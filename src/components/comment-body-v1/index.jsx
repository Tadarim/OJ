...
const CommentBodyV1 = memo(({comment}) => {
        ...
        <BodyWrapper>
            <div className="comment-header">
                <div className="avatar-wrapper">
                    <a href={"/u/susu-5/"}>
                        <img src={comment.avatar_url} alt="susu-5" className="css-17cu2v5-CommentAvatar e19tnut63" />
                    </a>
            ...
            {showEditor ? <CommentsEditor cancel={true} cancelHandler={cancelHandler} ></CommentsEditor> :
                <div className="comment-toolbar">
                    <button type="button">
                        ...
                        <span className="btnContent">{comment.likes_count}</span>
                    </button>
