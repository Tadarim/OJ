            ...
            <div className="question-fast-picker-wrapper">
                <div className="question-fast-picker">
                    ...
                    <div className="picker-handlers">
                        ...
                        <button className='problem-random'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="picker-pagination-handlers">
                            <a href="/problems/maximum-non-negative-product-in-a-matrix/">
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div className="pagination-screen">1595/3130</div>
                            <a href="/problems/the-most-frequently-ordered-products-for-each-customer/">
                                <button>
                                    <span>下一题</span>
